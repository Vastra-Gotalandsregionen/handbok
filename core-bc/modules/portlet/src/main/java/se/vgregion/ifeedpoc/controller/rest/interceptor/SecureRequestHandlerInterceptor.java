...
public class SecureRequestHandlerInterceptor extends HandlerInterceptorAdapter {
    ...
    public final static List<String> METHODS_TO_CHECK = Collections.unmodifiableList(Arrays.asList("GET", "POST", "PUT", "DELETE"));

    @Override
    public boolean preHandle(HttpServletRequest request,
                             HttpServletResponse response, Object handler) throws Exception {

        ((ResponseStatus) ((HandlerMethod) handler).getMethod().getDeclaredAnnotations()[1]).value();
